...
public class DateTest extends ATest {
	...
	@Test
	public void getCompletedYearsTo() {
		assertEquals(new Date(1979, 8, 3).getCompletedYearsTo(new Date(1980, 8, 2)), 0);
		assertEquals(new Date(1979, 8, 3).getCompletedYearsTo(new Date(1980, 8, 4)), 1);
		assertEquals(new Date(1979, 8, 3).getCompletedYearsTo(new Date(1980, 8, 3)), 1);
		assertEquals(new Date(1979, 8, 3).getCompletedYearsTo(new Date(2019, 5, 15)), 39);
		assertEquals(new Date(1979, 8, 3).getCompletedYearsTo(new Date(2019, 8, 03)), 40);
	}
